  ...
  return (
    ...
    >
      ...
      <SliderPrimitive.Thumb
        className={`block h-3.5 w-3.5 rounded-full border border-border bg-card shadow transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${props.disabled ? "pointer-events-none" : ""}`}
        {...thumbProps}
      />
    </SliderPrimitive.Root>
  )
